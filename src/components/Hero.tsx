  ...
  return (
    <Stack pt={"100px"} w={"100%"} alignItems={"center"}>
      ...
      <Stack alignItems={"center"}>
        ...
        <Image mt={'0'} w={'93%'} src="https://assets.myntassets.com/f_webp,w_968,c_limit,fl_progressive,dpr_2.0/assets/images/2023/10/19/819918a3-e91b-49ce-bc09-7fba08bf227a1697697553126-1280x336--1-.jpg" />
      </Stack>
